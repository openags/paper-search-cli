# paper_search/academic_platforms/crossref.py
...
class CrossRefSearcher(PaperSource):
    ...
    USER_AGENT = "paper-search-cli/1.0.0 (https://github.com/Dragonatorul/paper-search-cli; mailto:paper-search@example.org)"
