...
from paper_search.config import get_env
...
# ── 1. arXiv ─────────────────────────────────────────────────────────────────
print("\n[1] arXiv")
from paper_search.academic_platforms.arxiv import ArxivSearcher
s = ArxivSearcher()
...
from paper_search.academic_platforms.pubmed import PubMedSearcher
s = PubMedSearcher()
...
from paper_search.academic_platforms.biorxiv import BioRxivSearcher
s = BioRxivSearcher()
...
from paper_search.academic_platforms.medrxiv import MedRxivSearcher
s = MedRxivSearcher()
...
from paper_search.academic_platforms.google_scholar import GoogleScholarSearcher
...
from paper_search.academic_platforms.iacr import IACRSearcher
s = IACRSearcher()
...
from paper_search.academic_platforms.semantic import SemanticSearcher
s = SemanticSearcher()
...
from paper_search.academic_platforms.crossref import CrossRefSearcher
s = CrossRefSearcher()
...
from paper_search.academic_platforms.openalex import OpenAlexSearcher
s = OpenAlexSearcher()
...
from paper_search.academic_platforms.pmc import PMCSearcher
s = PMCSearcher()
...
from paper_search.academic_platforms.core import CORESearcher
s = CORESearcher()
...
from paper_search.academic_platforms.europepmc import EuropePMCSearcher
s = EuropePMCSearcher()
...
from paper_search.academic_platforms.dblp import DBLPSearcher
s = DBLPSearcher()
...
from paper_search.academic_platforms.openaire import OpenAiresearcher
s = OpenAiresearcher()
...
from paper_search.academic_platforms.citeseerx import CiteSeerXSearcher
s = CiteSeerXSearcher()
...
from paper_search.academic_platforms.doaj import DOAJSearcher
s = DOAJSearcher()
papers = s.search("machine learning", max_results=5)
...
from paper_search.academic_platforms.base_search import BASESearcher
s = BASESearcher()
...
from paper_search.academic_platforms.zenodo import ZenodoSearcher
s = ZenodoSearcher()
...
from paper_search.academic_platforms.hal import HALSearcher
s = HALSearcher()
...
from paper_search.academic_platforms.ssrn import SSRNSearcher
s = SSRNSearcher()
...
from paper_search.academic_platforms.unpaywall import UnpaywallSearcher
s = UnpaywallSearcher()
